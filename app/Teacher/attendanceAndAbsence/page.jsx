      ...
      >
        <Flex mb={6} gap={4} align="center">
          <Box flex="1" position="relative">
            <Input placeholder="البحث عن" bg="bg.panel" borderRadius="xl" border="none" shadow="sm" pr="40px" />
            <Icon as={MdSearch} position="absolute" right="3" top="50%" transform="translateY(-50%)" color="gray.400" />
          </Box>
          <Button bg="bg.panel" p={2} borderRadius="xl" shadow="sm">
            <Icon as={MdNotificationsNone} fontSize="xl" color="black" />
          </Button>
        </Flex>

        <Box bg="bg.panel" p={{base: 4, md: 8}} borderRadius="2xl" shadow="sm" border="1px solid" borderColor="border.subtle">
          ...
          {view === "form" ? (
            <VStack align="stretch" gap={8}>
              <Grid templateColumns={{base: "1fr", md: "repeat(2, 1fr)"}} gap={{base: 8, md: 10}}>
                ...
                >
                  <HStack mb={4} gap={2}>
                    ...
                    <Text fontWeight="bold" color="fg.muted">المرحلة التعليمية</Text>
                  </HStack>
              ...
              <Box>
                <HStack mb={4} gap={2}>
                  ...
                  <Text fontWeight="bold" color="fg.muted">الصف الدراسي</Text>
                </HStack>
              ...
              <Box>
                <Text fontSize="sm" color="fg.muted" mb={2}>عنوان الموضوع</Text>
                <Input
            ...
            <VStack align="stretch" gap={8}>
              ...
              <HStack gap={4} p={4} bg="bg.subtle" borderRadius="xl">
                <Icon as={MdPeopleAlt} color="blue.500" />
                <Text fontWeight="bold" color="fg.muted">عدد الطلاب :</Text>
