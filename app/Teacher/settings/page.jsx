        ...
        <Box bg="white" p={{ base: 6, md: 10 }} borderRadius="3xl" border="1px solid #E2E8F0" shadow="sm">
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} gapX={10} gapY={6}>
            ...
            <Text 
              ...
              borderBottom="1px dashed #E2E8F0" mt={6} pb={2}
            >
              البيانات المهنية
            </Text>

            <VStack align="flex-start" gap={1.5}>
              <Text fontSize="xs" fontWeight="bold" color="gray.500" pr={2}>المادة الدراسية</Text>
              <Input 
                {...inputStyle}
                name="specialization"
            ...
            <VStack align="flex-start" gap={1.5}>
              <Text fontSize="xs" fontWeight="bold" color="gray.500" pr={2}>اللقب المهني</Text>
              <Input 
                {...inputStyle}
                name="jobTitle"
            ...
            <VStack align="flex-start" gap={1.5}>
              <Text fontSize="xs" fontWeight="bold" color="gray.500" pr={2}>المستويات</Text>
              <Input 
                {...inputStyle}
                name="city"
            ...
            <VStack align="flex-start" gap={1.5} gridColumn={{ base: "auto", md: "span 2" }}>
              <Text fontSize="xs" fontWeight="bold" color="gray.500" pr={2}>النبذة التعريفية</Text>
              <Textarea 
                {...inputStyle}
                h="auto"
                name="bio"
